...
BEGIN
  RETURN QUERY
      SELECT  session_floor, session_room, session_date, session_time, booker_id
      FROM Sessions 
      WHERE session_date >= start_date
